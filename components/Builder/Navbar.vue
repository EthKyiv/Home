...
<template>
  <div
    ref="navbar"
    class="py-2 top-0 z-40 w-full flex-none transition-colors duration-300 md:z-50 border-b border-gray-800 dark:border-slate-300/[0.2] bg-ugradient"
  >
    <div id="navbar-banner" class="banner">
      <slot name="banner" />
    </div>
    <div class="max-w-8xl w-full mx-auto">
      <div class="py-3 md:px-8 mx-4 md:mx-0">
        <div class="relative flex items-center">
          <!-- drawer:toggle -->
          <div
            v-if="$slots['drawer']"
            class="md:hidden flex items-center self-center justify-center mr-2"
          >
            <button
          ...
          <slot name="title">
            ...
            >
              ...
              <span class="flex items-center">
                <BrandLogo
                  class="inline-block mr-2 text-lg h-7 w-20 md:h-9 md:w-30 text-black"
                  :alt="app.name"
                />
              </span>
            </NuxtLink>
      ...
      <Teleport to="#app-after">
        ...
        <Transition name="slide-fade-from-up" mode="out-in">
          <div
            ...
            class="fixed md:hidden bg-gray-100 dark:bg-slate-800 pt-12 top-0 left-0 w-screen h-screen z-30 flex flex-col"
          >
