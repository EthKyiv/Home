  ...
  <div class="flex items-center">
    ...
    >
      ...
      >
        ...
        <span
          class="justify-center items-center hidden dark:flex text-blue-300"
        >
          <IconUil:moon />
        </span>
      </ListboxButton>
    ...
    <select
      ...
      v-model="themeSetting"
      class="w-full px-2 pr-3 py-1 outline-none rounded border bg-transparent text-gray-700 dark:text-slate-300 border-gray-900/10 dark:border-gray-50/[0.2]"
    >
      <option
        v-for="theme in availableThemes"
        :key="theme.key"
